...
- [ADR-005](../adr/ADR-005-dev-auth-provider.md) — the OIDC/provider-agnostic decision this spec's login flow follows
- [ADR-006](../adr/ADR-006-shadcn-ui-and-native-login.md) — adds the native login form and `POST /auth/token`
